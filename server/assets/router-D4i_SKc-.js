...
const appCss = "/assets/styles-BQWrtmwn.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Signify — Sign Contracts with Ease" },
      { name: "description", content: "Write contracts, capture signatures, and export signed PDFs in seconds with Signify." }
    ],
    links: [
...
const $$splitComponentImporter = () => import("./index-DSf-Yi_o.js");
